...
<div class="w3-container">
  ...
  <input class="w3-input w3-border w3-padding" type="text" placeholder="Search for User names.." id="myInput" onkeyup="mySearchFunction()">
 ...
 //-----------------------------------------------onpage load starts here to fill up tabel---------------------          
  ...
  $(document).ready(function(){
        var flag=0;
         $.ajax({
                 type : "GET",
                 url :"http://10.0.2.250:8080/WebServices/GetService/issued",
